...
- Day-view tour + lodging interleaving fix [C39]: COMPLETE. Chat 39 commit [HASH].
- Day-view "From X" previous-endpoint header fix [C39]: COMPLETE. Chat 39 commit [HASH].
