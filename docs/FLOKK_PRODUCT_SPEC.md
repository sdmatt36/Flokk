...
- Stop "View on Maps" link rewire [C39]: COMPLETE. Chat 39 commit TBD.
- Per-stop X delete + add-new-stop on Trip Tours expand-in-place [C39]: COMPLETE. Chat 39 commit TBD.
