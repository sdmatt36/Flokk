// scripts/backfill-curated-city-photos.mjs
//
// Backfills City.priorityRank, City.heroPhotoUrl, City.heroPhotoAttribution
// for the curated 150-city list via Unsplash API.
//
// Usage:
//   DEMO=1 node scripts/backfill-curated-city-photos.mjs   → first 7 only, halt
//   FORCE=1 node scripts/backfill-curated-city-photos.mjs  → re-fetch even if heroPhotoUrl set
//   node scripts/backfill-curated-city-photos.mjs          → full run (all 150)
...
if (!UNSPLASH_KEY) {
  console.error("FATAL: NEXT_PUBLIC_UNSPLASH_ACCESS_KEY not set");
  process.exit(1);
}

const IS_DEMO = process.env.DEMO === "1";
const IS_FORCE = process.env.FORCE === "1";
const BATCH_SIZE = 5;
...
// Inline the curated list to avoid TS transpilation at runtime.
// Generated from scripts/data/curated-cities.ts — keep in sync.
const CURATED_CITIES_ALL = [
  ...
  { name: "New York City", country: "United States", priorityRank: 4, unsplashKeyword: "New York skyline Brooklyn Bridge" },
  ...
  { name: "Venice", country: "Italy", priorityRank: 7, unsplashKeyword: "Venice Grand Canal gondola" },
  { name: "Florence", country: "Italy", priorityRank: 8, unsplashKeyword: "Florence Duomo Tuscany" },
  ...
  { name: "Reykjavík", country: "Iceland", priorityRank: 14, unsplashKeyword: "Reykjavik Hallgrimskirkja mountains" },
  ...
  { name: "Petra", country: "Jordan", priorityRank: 22, unsplashKeyword: "Petra Treasury rose city Jordan" },
  ...
  { name: "Edinburgh", country: "Scotland", priorityRank: 27, unsplashKeyword: "Edinburgh Castle Royal Mile" },
  ...
  { name: "Siem Reap", country: "Cambodia", priorityRank: 33, unsplashKeyword: "Siem Reap Angkor Wat sunrise" },
  ...
  { name: "Galápagos", country: "Ecuador", priorityRank: 44, unsplashKeyword: "Galapagos islands wildlife" },
  ...
  { name: "Bali", country: "Indonesia", priorityRank: 52, unsplashKeyword: "Bali Ubud rice terraces temple" },
  ...
  { name: "Krabi", country: "Thailand", priorityRank: 56, unsplashKeyword: "Krabi limestone cliffs Railay" },
  { name: "Honolulu", country: "United States", priorityRank: 57, unsplashKeyword: "Honolulu Diamond Head Waikiki" },
  { name: "Bora Bora", country: "France", priorityRank: 58, unsplashKeyword: "Bora Bora overwater bungalow lagoon" },
  ...
  { name: "San Francisco", country: "United States", priorityRank: 61, unsplashKeyword: "San Francisco Golden Gate Bridge" },
  ...
  { name: "Las Vegas", country: "United States", priorityRank: 64, unsplashKeyword: "Las Vegas Strip night neon" },
  { name: "Miami", country: "United States", priorityRank: 65, unsplashKeyword: "Miami Beach Art Deco ocean" },
  { name: "New Orleans", country: "United States", priorityRank: 66, unsplashKeyword: "New Orleans French Quarter balcony" },
  { name: "Washington", country: "United States", priorityRank: 67, unsplashKeyword: "Washington DC Capitol cherry blossoms" },
  { name: "Boston", country: "United States", priorityRank: 68, unsplashKeyword: "Boston historic skyline Charles River" },
  { name: "Seattle", country: "United States", priorityRank: 69, unsplashKeyword: "Seattle Space Needle Mount Rainier" },
  { name: "Vancouver", country: "Canada", priorityRank: 70, unsplashKeyword: "Vancouver skyline mountains harbor" },
  { name: "Toronto", country: "Canada", priorityRank: 71, unsplashKeyword: "Toronto CN Tower skyline" },
  { name: "Montréal", country: "Canada", priorityRank: 72, unsplashKeyword: "Montreal Old Port Notre-Dame" },
  { name: "Quebec City", country: "Canada", priorityRank: 73, unsplashKeyword: "Quebec City Chateau Frontenac old town" },
  { name: "Antigua", country: "Guatemala", priorityRank: 74, unsplashKeyword: "Antigua Guatemala volcano arch" },
  { name: "Tulum", country: "Mexico", priorityRank: 75, unsplashKeyword: "Tulum Mayan ruins beach" },
  { name: "Cancún", country: "Mexico", priorityRank: 76, unsplashKeyword: "Cancun beach turquoise Caribbean" },
  { name: "Panama City", country: "Panama", priorityRank: 77, unsplashKeyword: "Panama City skyline Casco Viejo" },
  { name: "San José", country: "Costa Rica", priorityRank: 78, unsplashKeyword: "Costa Rica rainforest cloud forest" },
  ...
  { name: "Bogotá", country: "Colombia", priorityRank: 81, unsplashKeyword: "Bogota Monserrate mountains" },
  { name: "Puerto Iguazú", country: "Argentina", priorityRank: 82, unsplashKeyword: "Iguazu Falls waterfall jungle" },
  ...
  { name: "Seville", country: "Spain", priorityRank: 86, unsplashKeyword: "Seville Plaza España Alcázar" },
  { name: "Granada", country: "Spain", priorityRank: 87, unsplashKeyword: "Granada Alhambra palace Andalusia" },
  { name: "Porto", country: "Portugal", priorityRank: 88, unsplashKeyword: "Porto Douro River bridges" },
  ...
  { name: "Krakow", country: "Poland", priorityRank: 96, unsplashKeyword: "Krakow main square medieval cathedral" },
  { name: "Tallinn", country: "Estonia", priorityRank: 97, unsplashKeyword: "Tallinn old town medieval towers" },
  { name: "Bergen", country: "Norway", priorityRank: 98, unsplashKeyword: "Bergen Norway harbor wooden houses" },
  { name: "Oslo", country: "Norway", priorityRank: 99, unsplashKeyword: "Oslo Opera House fjord" },
  { name: "Tromsø", country: "Norway", priorityRank: 100, unsplashKeyword: "Tromso northern lights Norway" },
  { name: "Helsinki", country: "Finland", priorityRank: 101, unsplashKeyword: "Helsinki Senate Square cathedral" },
  { name: "Fes", country: "Morocco", priorityRank: 102, unsplashKeyword: "Fez medina tannery old city" },
  ...
  { name: "Tel Aviv", country: "Israel", priorityRank: 108, unsplashKeyword: "Tel Aviv Mediterranean coastline" },
  { name: "Stone Town", country: "Tanzania", priorityRank: 109, unsplashKeyword: "Stone Town Zanzibar architecture" },
  ...
  { name: "Samarkand", country: "Uzbekistan", priorityRank: 124, unsplashKeyword: "Samarkand Registan Uzbekistan" },
  { name: "Bukhara", country: "Uzbekistan", priorityRank: 125, unsplashKeyword: "Bukhara silk road architecture" },
  ...
  { name: "Cairns", country: "Australia", priorityRank: 129, unsplashKeyword: "Cairns Great Barrier Reef rainforest" },
  { name: "Tahiti", country: "France", priorityRank: 130, unsplashKeyword: "Tahiti waterfall mountains lagoon" },
  { name: "Anaheim", country: "United States", priorityRank: 131, unsplashKeyword: "Disneyland California castle" },
  { name: "Orlando", country: "United States", priorityRank: 132, unsplashKeyword: "Orlando Disney Magic Kingdom castle" },
  { name: "Nashville", country: "United States", priorityRank: 133, unsplashKeyword: "Nashville Broadway music neon" },
  ...
  { name: "Jackson Hole", country: "United States", priorityRank: 137, unsplashKeyword: "Jackson Hole Tetons Wyoming" },
  ...
  { name: "Whitefish", country: "United States", priorityRank: 141, unsplashKeyword: "Glacier National Park lake Montana" },
  ...
  { name: "Grand Canyon Village", country: "United States", priorityRank: 144, unsplashKeyword: "Grand Canyon South Rim sunset" },
  { name: "Banff", country: "Canada", priorityRank: 145, unsplashKeyword: "Banff Lake Louise Canadian Rockies" },
  { name: "Roatán", country: "Honduras", priorityRank: 146, unsplashKeyword: "Roatan beach Caribbean diving" },
  { name: "Maldives", country: "Maldives", priorityRank: 147, unsplashKeyword: "Maldives overwater bungalow lagoon" },
  { name: "Malé", country: "Maldives", priorityRank: 148, unsplashKeyword: "Male Maldives island aerial" },
  { name: "Marrakech", country: "Morocco", priorityRank: 149, unsplashKeyword: "Marrakech Jemaa el-Fnaa souks" },
  { name: "Reykjavík", country: "Iceland", priorityRank: 150, unsplashKeyword: "Reykjavik Hallgrimskirkja harbor" },
];

// ── DEMO cities (first 7) ─────────────────────────────────────────────────────
// Paris/Rome/London/NYC/Barcelona — expect DB match + Unsplash photo
// Petra/Bali — canaries: Petra is in DB (Jordan), Bali is NOT a city in DB
const DEMO_CITY_NAMES = ["Paris", "Rome", "London", "New York City", "Barcelona", "Petra", "Bali"];
...
function pickBestPhoto(results) {
  ...
  // Prefer landscape >= 1600x900
  const hires = results.filter((p) => p.width >= 1600 && p.height >= 900);
  if (hires.length) return hires[0];
  // Fallback: highest resolution (width * height)
...
async function processCity(db, curated) {
  // DB lookup: ILIKE on name + country.name
  const city = await db.city.findFirst({
    where: {
      name: { equals: curated.name, mode: "insensitive" },
      country: { name: { equals: curated.country, mode: "insensitive" } },
    },
    select: { id: true, name: true, heroPhotoUrl: true },
  });

  if (!city) {
    console.log(`  SKIP  [rank ${curated.priorityRank}] ${curated.name}, ${curated.country} — not found in DB`);
    return { status: "not_found" };
  }

  if (city.heroPhotoUrl && !IS_FORCE) {
    console.log(`  SKIP  [rank ${curated.priorityRank}] ${curated.name} — heroPhotoUrl already set (use FORCE=1 to override)`);
  ...
  let results;
  try {
    results = await unsplashSearch(curated.unsplashKeyword);
  } catch (err) {
    console.log(`  ERROR [rank ${curated.priorityRank}] ${curated.name} — Unsplash error: ${err.message}`);
    return { status: "unsplash_error" };
  }

  const picked = pickBestPhoto(results);
  if (!picked) {
    console.log(`  SKIP  [rank ${curated.priorityRank}] ${curated.name} — no Unsplash results for keyword "${curated.unsplashKeyword}"`);
    return { status: "no_photo" };
  }

  const attribution = JSON.stringify({
    photographerName: picked.user.name,
    photographerUrl: picked.user.links.html + "?utm_source=flokk&utm_medium=referral",
    photoUrl: picked.links.html + "?utm_source=flokk&utm_medium=referral",
    source: "unsplash",
  });
  ...
  await db.city.update({
    where: { id: city.id },
    data: {
      heroPhotoUrl: picked.urls.regular,
      heroPhotoAttribution: attribution,
      priorityRank: curated.priorityRank,
    },
  });

  // Unsplash requires download tracking per API guidelines
  await triggerDownload(picked.links.download_location);

  console.log(`  OK    [rank ${curated.priorityRank}] ${curated.name} — "${picked.user.name}" — ${picked.width}x${picked.height}`);
  console.log(`        ${picked.urls.regular.slice(0, 80)}`);

  return { status: "ok", photoUrl: picked.urls.regular, photographer: picked.user.name };
}
...
async function main() {
  ...
  const citiesToProcess = IS_DEMO
    ? CURATED_CITIES_ALL.filter((c) => DEMO_CITY_NAMES.includes(c.name))
    : CURATED_CITIES_ALL;

  if (IS_DEMO) {
    console.log(`\n=== DEMO MODE — processing ${citiesToProcess.length} cities ===\n`);
  } else {
    console.log(`\n=== FULL RUN — processing ${citiesToProcess.length} cities ===\n`);
  }

  const stats = { processed: 0, ok: 0, not_found: 0, already_set: 0, no_photo: 0, error: 0 };
  const notFoundNames = [];

  for (let i = 0; i < citiesToProcess.length; i += BATCH_SIZE) {
    const batch = citiesToProcess.slice(i, i + BATCH_SIZE);

    const results = await Promise.all(batch.map((c) => processCity(db, c)));

    for (let j = 0; j < results.length; j++) {
      const r = results[j];
      stats.processed++;
      if (r.status === "ok") stats.ok++;
      else if (r.status === "not_found") { stats.not_found++; notFoundNames.push(`${batch[j].name}, ${batch[j].country}`); }
      else if (r.status === "already_set") stats.already_set++;
      else if (r.status === "no_photo") stats.no_photo++;
      else stats.error++;
    }

    if (!IS_DEMO && stats.processed % 10 === 0) {
      console.log(`\n  --- Progress: ${stats.processed}/${citiesToProcess.length} processed ---\n`);
    }

    if (i + BATCH_SIZE < citiesToProcess.length) {
  ...
  console.log(`  Photos set:  ${stats.ok}`);
  console.log(`  Already set: ${stats.already_set}`);
  console.log(`  Not in DB:   ${stats.not_found}`);
  console.log(`  No photo:    ${stats.no_photo}`);
  ...
  const matchRate = ((stats.processed - stats.not_found) / stats.processed) * 100;
  if (!IS_DEMO && stats.not_found > 45) {
    console.log(`\nWARNING: match rate ${matchRate.toFixed(1)}% (below 70%). Review unmatched cities above.`);
  }

  if (IS_DEMO) {
    console.log(`\n${"=".repeat(60)}`);
    console.log(`DEMO complete. Review results above, then run full backfill:`);
    console.log(`  node scripts/backfill-curated-city-photos.mjs`);
