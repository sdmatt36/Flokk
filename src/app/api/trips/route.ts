...
export async function GET(request: Request) {
  ...
  return NextResponse.json(
    { trips: trips.map(t => ({ id: t.id, title: t.title, destinationCity: t.destinationCity, destinationCountry: t.destinationCountry, cities: t.cities, country: t.country, startDate: t.startDate, endDate: t.endDate, status: t.status, isPlacesLibrary: t.isPlacesLibrary })) },
