  ...
  return (
    <div>
      ...
      {availablePillCities.length > 0 && (
        <div
          style={{ display: "flex", gap: "8px", overflowX: "auto", overscrollBehaviorX: "contain", paddingBottom: "8px", marginBottom: "12px", scrollbarWidth: "none", msOverflowStyle: "none", width: "100%" }}
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#FFFFFF", paddingBottom: "96px" }}>
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "32px 24px 0" }}>
        ...
        <div style={{ paddingTop: "64px" }}>
          ...
          <div style={{ display: "flex", gap: "8px", overflowX: "auto", overscrollBehaviorX: "contain", paddingBottom: "12px", marginBottom: "28px", scrollbarWidth: "none", msOverflowStyle: "none", width: "100%" }} className="hide-scrollbar">
        ...
        <div style={{ paddingTop: "64px" }}>
          ...
          {/* Filter pills */}
          <div
            style={{ display: "flex", gap: "8px", overflowX: "auto", overscrollBehaviorX: "contain", paddingBottom: "12px", marginBottom: "32px", scrollbarWidth: "none", msOverflowStyle: "none", width: "100%" }}
            className="hide-scrollbar"
          >
            {FILTERS.map((f) => (
              <button
